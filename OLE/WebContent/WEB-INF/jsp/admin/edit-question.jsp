...
<script type="text/javascript">
	$(document).ready(function() {
		displayAllExam('<%=request.getContextPath()%>/admin/exam/list', 'all-exams-detail-question-edit');
	});
</script>
</head>
<body>
...
<div style="text-align: center;">
	<div id="all-exams-detail-question-edit"></div>
	<div id="all-question-detail-edit" style="text-align: center; display: none;" ></div>
	<div id="question-edit-result" style="text-align: center; display: none;" ></div>
	<div id="question-edit-label"style="text-align: center; display: none;"><h3>Edit Question</h3></div>
	
	<form id="question-edit-form" method="post" style="display: none;">
		<table style="margin: 0 auto;">
			...
			<tr><td/><td><input type="button" value="Update" onclick="updateQuestion('<%=request.getContextPath()%>/admin/question');"/>
			<input type="button" value="Delete" onclick="deleteQuestion('<%=request.getContextPath()%>/admin/question');"/>
			</td></tr>
		</table>
	</form>
